...
namespace ARBOLESBB
{
    internal class ArbolBMulticamino
    {
        ...
        public ArbolBMulticamino()//contructor
        {
        ...
        public void Mostrar()//metodo  que llama a metodo mostrar esto es para encapsular mas.
        {
            Mostrar(padre, 0);
        }

        private void Mostrar(Nodo p, int espaciosblancos)// recibe nodo y espacios entre nodos o paginas
        {
            if (p != null)// si el nodo es diferente de nulo
            {
                int i;
                for (i = 1; i <= espaciosblancos; i++)// dejar espacios en blanco
                    Console.Write("-");//muestra espacios en blanco
                ...
                for (i = 0; i <= p.numclaves; i++)//este for recorre las paginas hijas para mostrar las claves
                    Mostrar(p.hijo[i], espaciosblancos + 10);// muestra las claves de las  páginas hijas
            }
        }
        ...
        private bool Insert(int x, Nodo p, ref int iclave, ref Nodo iclaveDhijo)
        {
            ...
            {
                Console.WriteLine("clave ya esta presente en el árbol");
        ...
        private void Borrar(int x, Nodo p)
        {
            ...
            else /*clave x no encontrada en Nodo p */
            {
                ...
                {
                    Console.WriteLine("Valor " + x + " no presente en el árbol");
                    return;
                }
